...
public class Constantes {
    ...
    public static final String[] RESULTADO_ESPERADO = {"BBBB", "NNNN", "TTTT", "MMMM"};
    public static final char B = 'B';
    public static final char N = 'N';
    public static final char T = 'T';
    public static final char M = 'M';
    public static final String MENSAJE_DE_NO_APROBACION= "Muchas gracias, pero no cumples con los requisitos.";
